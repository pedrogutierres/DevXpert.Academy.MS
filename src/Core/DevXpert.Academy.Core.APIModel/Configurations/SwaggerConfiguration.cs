using DevXpert.Academy.Core.APIModel.Filters;
    ...
    public static class SwaggerConfiguration
    {
        ...
        public static IApplicationBuilder UseSwaggerConfig(this IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(s =>
                {
                    s.SwaggerEndpoint("/swagger/v1/swagger.json", "DevXpert.Academy Microsserviços API v1.0");
                });
            }
